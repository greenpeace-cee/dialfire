 ...
 */
class CRM_Dialfire_Upgrader_Base {

  /**
   * @var CRM_Dialfire_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Dialfire_Upgrader(
        'dialfire',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Dialfire_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Dialfire_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
